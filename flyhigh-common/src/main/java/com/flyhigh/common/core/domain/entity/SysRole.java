...
public class SysRole extends BaseEntity {
     ...
     * 角色分类 1 集团角色 2 子公司角色
     */
    @ApiModelProperty(value = "角色分类 1 集团角色 2 子公司角色")
     ...
     * 是否是三级网格员 0 否 1 是
     */
    @ApiModelProperty(value = "是否是三级网格员 0 否 1 是")
    private Integer whetherThirdManager;
    ...
    public Integer getWhetherThirdManager() {
        return whetherThirdManager;
    }

    public void setWhetherThirdManager(Integer whetherThirdManager) {
        this.whetherThirdManager = whetherThirdManager;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("whetherThirdManager", getWhetherThirdManager())
                .toString();
    }
}
