 ...
 */
@Component
@ConfigurationProperties(prefix = "flyhigh")
public class FlyhighConfig {
    /**
     * 项目名称
     */
    private String name;
    ...
    public void setWinProfile(String winProfile) {
        FlyhighConfig.winProfile = winProfile;
    }
    ...
    public void setLinuxProfile(String linuxProfile) {
        FlyhighConfig.linuxProfile = linuxProfile;
    }
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        FlyhighConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        FlyhighConfig.captchaType = captchaType;
    }
