...
import com.flyhigh.common.annotation.DataSource;
...
import com.flyhigh.common.enums.DataSourceType;
...
import com.flyhigh.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    @Override
    public SysConfig selectInfoConfigByKey(String key) {
        SysConfig config = new SysConfig();
    ...
    public boolean selectCaptchaOnOff() {
        String captchaOnOff = selectConfigByKey(SysConfigEnum.CAPTCHA_ON_OFF.getKey());
     ...
     */
    @Override
    public int updateConfigValueByKey(String configKey, String configValue) {
        int row = configMapper.updateConfigValueByKey(configKey, configValue);
        if (row > 0) {
