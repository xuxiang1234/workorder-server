...
import com.flyhigh.common.utils.MessageUtils;
...
import com.flyhigh.system.domain.LoginParams;
...
public class MobileLoginService {
    ...
    public AjaxResult<Map<String, Object>> login(LoginParams loginParams) {
...
//        }
    ...
    public AjaxResult<Map<String, Object>> registerUser(LoginParams loginParams) {
        try {
            if (Objects.isNull(loginParams)) {
                return AjaxResult.error(-6, "参数为空");
            }
